...
app.register.controller('merchantSettingCtrl', ['$rootScope', '$scope', '$http', '$modal', '$state', '$stateParams', '$sce', 'dateFilter',
    ...
    // 注册商户详情控制器
   app.register.controller('merchantDetailCtrl', ['$scope', '$modalInstance', 'merchant', function ($scope, $modalInstance, merchant) {
        $scope.title = '商户详情';
        $scope.titleIcon = '';
    ...
    // 注册商户详情修改控制器
    app.register.controller('merchantUpdateCtrl', ['$scope', '$modalInstance', 'merchant', function ($scope, $modalInstance, merchant) {
        $scope.title = '商户信息修改';
