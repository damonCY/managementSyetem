define(function(require,exports,module){
    ...
    app.register.controller('operateMerchantSettlementCtrl', ['$rootScope', '$scope', '$http', '$modal', '$state', '$stateParams', '$sce', 'dateFilter', 'FileUploader',
        ...
        // 注册商户详情修改控制器
        app.register.controller('settlementUpdateCtrl', ['$scope', '$modalInstance', 'settlement', function ($scope, $modalInstance, settlement) {
