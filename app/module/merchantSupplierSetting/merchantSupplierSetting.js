define(function(require,exports,module){
    ...
    app.register.controller('merchantSupplierSettingCtrl', ['$rootScope', '$scope', '$http', '$modal', '$state', '$stateParams', '$sce', 'dateFilter',
    ...
    // 注册商户详情控制器
    app.register.controller('supplierDetailCtrl', ['$scope', '$modalInstance', 'supplier', function ($scope, $modalInstance, supplier) {
        $scope.title = '商户供应商详情';
        $scope.titleIcon = '';
    ...
    // 注册商户详情修改控制器
    app.register.controller('supplierUpdateCtrl', ['$scope', '$modalInstance', 'supplier', function ($scope, $modalInstance, supplier) {
