define(function(require,exports,module){
    ...
    app.register.controller('transactionCtrl', ['$rootScope', '$scope', '$http', '$modal', '$state', '$stateParams', '$sce', 'dateFilter',
    ...
    .success(function(data, status, headers, config) {
        ...
        console.log("bizTypesOptions-----"+JSON.stringify(bizTypes))
        $scope.bizStatusOptions = bizTypes[0].bizStatuss;
        $scope.bizIdsOptions = bizTypes[0].bizIds;
    ...
    // 注册商户详情控制器
    app.register.controller('transactionDetailCtrl', ['$scope', '$modalInstance', 'biz', function ($scope, $modalInstance, biz) {
        $scope.title = '交易详情';
        $scope.titleIcon = '';
